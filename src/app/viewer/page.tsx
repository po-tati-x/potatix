...
export default function ViewerPage() {
  ...
  // Extreme debug - log every param we get
  console.log('[Viewer DEBUG] All search params:', 
    Array.from(searchParams.entries()).map(([k,v]) => `${k}=${v}`).join(', ') || 'NONE');
  
  const courseSlug = searchParams.get('course');
  console.log('[Viewer DEBUG] Course slug from params:', courseSlug);
