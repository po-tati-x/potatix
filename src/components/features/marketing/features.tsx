...
import { BentoGrid, BentoGridItem } from "@/components/ui/potatix/bento-grid";
...
const FEATURES: FeatureProps[] = [
  ...
  {
    title: "Custom domain",
    description: "Use your own domain or get a free yourname.potatix.com subdomain.",
            ...
            <BentoGrid className="grid-cols-2 xl:grid-cols-4 gap-5">
              {FEATURES.map((feature, index) => (
                <BentoGridItem
                  ...
                  icon={
                    <div className={`rounded p-2 ${feature.accentColor} text-white`}>
                      {feature.icon}
                    </div>
                  }
