 ...
 */
export declare const getBaseOptions: (db: DatabaseInstance) => {
    database: (options: BetterAuthOptions) => import("better-auth").Adapter;
};
export declare const createAuth: ({ webUrl, db, authSecret, plugins, cookieDomain, }: AuthOptions) => {
